...
INSERT INTO `assessments_taken` VALUES (13,2,1,'INFP INFPs have an inner core of values that they use to drive their relationships and judgments. They want to be involved in work that benefits both their own and others\" growth and development, and they want to have a purpose that goes beyond their wage. They make it a point to define their ideals and live in accordance with them. INFPs understand and respect the emotional and psychological needs of others, even when such needs aren\"t acknowledged or stated by others.',NULL),(14,1,1,'Openness: 38%\nCooperativeness: 59%\nAdjustment: 51%\nPersistence: 49%\nAgreeableness: 38%\nAmbition: 36%\nOpenness to Experience: 33%\nLearning Approach: 45%',NULL);
...
--
-- Table structure for table `emotions_detected`
--

DROP TABLE IF EXISTS `emotions_detected`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `emotions_detected` (
  `idemotions_detected` int NOT NULL AUTO_INCREMENT,
  `idjob_postings` varchar(45) DEFAULT NULL,
  `iduser_candidate` varchar(45) DEFAULT NULL,
  `Anger` varchar(45) DEFAULT NULL,
  `Contempt` varchar(45) DEFAULT NULL,
  `Disgust` varchar(45) DEFAULT NULL,
  `Fear` varchar(45) DEFAULT NULL,
  `Happiness` varchar(45) DEFAULT NULL,
  `Neutral` varchar(45) DEFAULT NULL,
  `Sadness` varchar(45) DEFAULT NULL,
  `Surprise` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idemotions_detected`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `emotions_detected`
--

LOCK TABLES `emotions_detected` WRITE;
/*!40000 ALTER TABLE `emotions_detected` DISABLE KEYS */;
INSERT INTO `emotions_detected` VALUES (10,'2','1','undefined','undefined','undefined','undefined','0.3333333333333333','0.6666666666666666','undefined','undefined'),(11,'2','1','undefined','undefined','undefined','undefined','0.2','0.5','undefined','undefined'),(12,'2','1','undefined','undefined','undefined','undefined','0.6666666666666666','0.3333333333333333','undefined','undefined'),(13,'2','1','undefined','undefined','undefined','undefined','0.3333333333333333','0.6666666666666666','undefined','undefined'),(14,'2','1','undefined','undefined','undefined','undefined','0.15384615384615385','0.8461538461538461','undefined','undefined'),(15,'2','1','undefined','undefined','undefined','undefined','0.6666666666666666','0.3333333333333333','undefined','undefined'),(16,'2','1','undefined','undefined','undefined','undefined','undefined','undefined','undefined','undefined'),(17,'2','1','undefined','undefined','undefined','undefined','undefined','undefined','undefined','undefined'),(18,'2','1','undefined','undefined','undefined','undefined','undefined','undefined','undefined','undefined');
/*!40000 ALTER TABLE `emotions_detected` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `employer` VALUES (1,'Valsium Inc.','salman.younus512@gmail.com','1','123456','We are not just any company, we are a rebellion, to start the great digital uprising. We will lead this era to a new dawn, a better future for tomorrow. No longer bound by the limitations of society, we will transcend humanity to the future of A.I.','We hire intelligent and brilliant candidates.','Karachi, Pakistan','www.valsium.com','25','Finance','2005');
/*!40000 ALTER TABLE `employer` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `interviews_complete`
--

DROP TABLE IF EXISTS `interviews_complete`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `interviews_complete` (
  `idinterviews_complete` int NOT NULL AUTO_INCREMENT,
  `idjob_postings` varchar(45) NOT NULL,
  `iduser_candidate` varchar(45) NOT NULL,
  PRIMARY KEY (`idinterviews_complete`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `interviews_complete`
--

LOCK TABLES `interviews_complete` WRITE;
/*!40000 ALTER TABLE `interviews_complete` DISABLE KEYS */;
/*!40000 ALTER TABLE `interviews_complete` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `interviews_schedule`
--

DROP TABLE IF EXISTS `interviews_schedule`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `interviews_schedule` (
  `idinterviews_schedule` int NOT NULL AUTO_INCREMENT,
  `idjob_postings` varchar(45) NOT NULL,
  `iduser_candidate` varchar(45) NOT NULL,
  PRIMARY KEY (`idinterviews_schedule`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `interviews_schedule`
--

LOCK TABLES `interviews_schedule` WRITE;
/*!40000 ALTER TABLE `interviews_schedule` DISABLE KEYS */;
/*!40000 ALTER TABLE `interviews_schedule` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `job_postings` (
  ...
  `Interview_Required` varchar(45) NOT NULL,
  `Question_1` mediumtext,
  `Question_2` mediumtext,
  `Question_3` mediumtext,
  `Hidden` varchar(45) NOT NULL DEFAULT 'No',
...
CREATE TABLE `job_result` (
  `idjob_result` int NOT NULL AUTO_INCREMENT,
  `idjob_postings` varchar(45) DEFAULT NULL,
  `iduser_candidate` varchar(45) DEFAULT NULL,
  `result` varchar(256) DEFAULT NULL,
  PRIMARY KEY (`idjob_result`)
...
INSERT INTO `job_result` VALUES (3,'2','1','Yes');
...
INSERT INTO `user_candidate` VALUES (1,'salman','salman.younus512@gmail.com','1','03353394033','Male','Web Developer','Junior Developer','computer science major','123','321','','','PHP\nHTML\nSQL\nReact');
...
-- Dump completed on 2022-05-14  0:10:49
